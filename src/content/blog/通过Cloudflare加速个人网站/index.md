...
slug: 'tong-guo-cloudflare-jia-su-ge-ren-wang-zhan'
tags:
  - 建站
  - 教程
language: '中文'
...
![Cloudflare 控制台账户主页（账号 2169702639@qq.com）的「域」区域：supermortal.cn 已添加并启用，旁边还有 my-blog 的 Workers 和 Pages 项目；面板同时展示安全（Encrypted requests 100%）、性能（缓存率 9.5%）、活动（Web 流量 317）等概览数据](cloudflare.png)
...
![腾讯云 DNSPod「修改 DNS 服务器」弹窗：域名 supermortal.cn，DNS 服务器选择「使用非腾讯云 DNS」（推荐为 DNSPod），把 Cloudflare 分配的 ns 记录填入下方两个输入框后提交，提示修改后 24~48 小时全球生效](txy.png)
