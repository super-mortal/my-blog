...
![Cloudflare 控制台 supermortal.cn 流量统计概览（4 月 27 日 - 5 月 27 日，近 30 天）：唯一访问者 1.13k、请求总数 14.73k，每天 UV 稳定在 20-90 之间、请求量在 100-2k 之间波动，作为博客接入 JSON-LD 结构化数据后搜索引擎收录效果与稳定访问量的佐证](cloudflare统计.png)
