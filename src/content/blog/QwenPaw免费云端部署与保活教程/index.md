...
先说清楚这是个啥。**QwenPaw** 是阿里通义 AgentScope 团队开源的个人 AI 智能体，数据存在本地，支持钉钉/飞书/QQ/元宝/Telegram/Discord 一堆渠道。**AgentScope Platform** 是它的官方云端体验平台，公测期间**绑定 GitHub 就能永久领一个免费的 7×24 实例**——不用自己买服务器，这波羊毛不薅白不薅。

### 1.前置准备

1. 一个 GitHub 账号（平台唯一身份，公测每人限领 1 只）
2. 一个邮箱（注册用，不限阿里系）
3. 一个国内或海外 IM 账号（可选，接 IM 用；本教程以 Telegram 演示，国内节点可以换成 QQ机器人 / 腾讯元宝 / 飞书 / 钉钉等）
...
> 平台实例 **48 小时不发消息会自动关机**，所以得配个定时任务，每天定时给机器人发条消息，让实例一直"活着"。
