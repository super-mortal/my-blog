...
slug: 'gpt-chong-zhi-lou-dong-jie-xi'
tags:
  - AI
language: '中文'
category: 知识点
...
![OpenAI 官方社区 ChatGPT Bugs 板块的安全报告截图：摘要指出 iOS ChatGPT 订阅校验流程中存在逻辑漏洞——后端只通过 Apple 验证收据（receipt-data）签名真实性与账号有效性，但并不校验收据所属 Apple ID 与接收 Plus 升级的 OpenAI 账号是否一致（Technical Background: Expected Flow 第 4 步「Does NOT verify」用红叉标出），导致任意已付费 Apple 收据可被无限次复用于激活 ChatGPT Plus/Pro 订阅](01.png)
