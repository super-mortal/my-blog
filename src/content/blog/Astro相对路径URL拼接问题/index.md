...
slug: 'Astro-kuang-jia-zhong-xiang-dui-lu-jing-zai-url-ping-jie-shi-de-bu-que-ding-xing-wen-ti'
tags:
  - 建站
  - 爬虫
language: '中文'
...
![书签管理工具的「创建书签」表单，爬虫正确抓取到 supermortal.cn 的 OG 元数据：网址 https://supermortal.cn、标题 Home、描述「super-mortal, 一个在数字世界中默默无闻的凡人」、图片网址 https://supermortal.cn/images/social-card.png，右侧带 social-card 缩略图](./01.png)
...
![QQ 聊天分享 supermortal.cn 主页与博客文章链接后，正确渲染出 Open Graph 预览卡片：主页显示「Home」标题与个人简介描述，文章链接显示「Astro框架中相对路径在URL拼接时的不确定性问题」标题与摘要、附缩略图，说明 social-card 改为绝对 URL 后 QQ 能正常抓取元数据](./02.png)

> **未修改之前无法正确抓取只能显示如下图所示的纯链接**

![QQ 聊天分享 supermortal.cn 主页与博客文章链接后，仅显示纯文本链接气泡 https://supermortal.cn 和 https://supermortal.cn/blog/astro-...，没有任何标题、描述、缩略图，正是修复前 social-card 使用相对路径被拼接成 localhost 时 QQ 无法抓取 OG 元数据的现象](./03.png)
