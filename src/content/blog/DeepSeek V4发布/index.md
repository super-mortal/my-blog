...
slug: 'deepseek-v4-zhong-yu-fa-bu'
tags:
  - AI
language: '中文'
category: 知识点
...
![DeepSeek-V4 Pro 与 Flash 版本对比表：V4-Pro 1.6T 总参数 / 49B 激活、33T 预训练数据、1M 上下文、专家模式；V4-Flash 284B 总参数 / 13B 激活、32T 预训练数据、1M 上下文、快速模式，两版本均开源并提供 API 服务](./01.png)
...
![DeepSeek-V4-Pro-Max 与 Claude-Opus-4.6-Max、GPT-5.4-xHigh、Gemini-3.1-Pro-High 性能测评对比柱状图：在 SimpleQA Verified（57.9）、Apex Shortlist（90.2）、Codeforces（3206）、SWE Verified（80.6）、Terminal Bench 2.0（67.9）、Toolathlon（51.8）等知识推理与 Agent 能力基准上 DeepSeek V4 Pro 全面领先](./02.png)
...
![DeepSeek-V4 Pro 与 Flash API 定价对比表：V4-Pro 缓存命中输入 1 元、未命中 12 元、输出 24 元 / 百万 token；V4-Flash 缓存命中输入 0.2 元、未命中 1 元、输出 2 元 / 百万 token，两版本均支持 1M 上下文，并注明因高端算力受限 Pro 吞吐有限、下半年昇腾 950 超节点批量上市后 Pro 价格会大幅下调](./03.png)
